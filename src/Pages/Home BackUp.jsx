    ...
    <>
      ...
      <img
        ...
        className={`toTop bg-purp fixed border border-[#99999930] shadow-lg opacity-50 hover:opacity-100 duration-200 ease-out ${
          scrollTop >= 200
            ? "bottom-4 lg:bottom-8 invisible opacity-0"
            : "-bottom-24 lg:-bottom-[120px] "
        } ${menuVis? "invisible opacity-0": "visible flex opacity-100"} duration-200 delay-200 right-4 lg:ring-0 rounded-xl p-2 w-14 z-[50]`}
      />

      <Sidebar active={menuVis} />
      <div
        ...
        } lg:py-0 p-4 md:px-8 lg:px-12 border-b border-[#6d3ec430]`}
      >
